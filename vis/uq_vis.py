...
data = "/Users/osoro/GitHub/saleos/results/"
results = "/Users/osoro/GitHub/saleos/vis/"
...
df = df[["constellation", "signal_path", "satellite_coverage_area_km", 
         ...
         "cnr", "spectral_efficiency","constellation_capacity", "capacity_per_area_mbps/sqkm"]]
...
df.columns = ["Constellation", "Signal path(km)","Satellite coverage area(km)", 
              ...
              "Spectral Efficiency(bits/hertz)","Constellation Capacity(Mbps)",
...
plt.title("Constellation Capacity Heatmap", fontsize = 25, fontfamily = "Helvetica")
plt.tight_layout()
...
for ax in x_axis:
    plt.figure(figsize=(20,15))
    sns.set(font_scale=2)
    sns.jointplot(x = ax, y = "Constellation Capacity(Mbps)", 
